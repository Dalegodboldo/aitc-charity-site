...
<figure>
  ...
  <figcaption>Mouseketeers and students at Disney Imagination Campus.</figcaption>
</figure>
...
If you missed the limited print run, there are still a few ways in:

- **Waiting list** — we've opened waiting lists with priority access to any potential second printing.
- **Master Digital Archive** — available now: the complete three-volume work in eBook and PDF, including access to filmed concerts and exclusive digital content.
- **Trade Edition** — a general release is planned, with details to come from the publisher.
- **In person** — a limited number of copies will be available at House of Mouse Expo (July 31–August 2, Orlando).

You can find all of it on [the book page](https://www.mickeymouseclubreunion.com/books).
...
To everyone who bought a book, joined a waiting list, or simply cheered us on: thank you. You turned a little nostalgia into something real that a young artist can carry for a lifetime. The mission continues — come [learn, grow, and thrive with us](/mentorship-coaching).
